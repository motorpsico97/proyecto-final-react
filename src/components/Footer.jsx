            ...
            <div className="footer-content">
                ...
                <div className="footer-section">
                    ...
                    <ul className="footer-links">
                        ...
                        {!loading && marcas.map(marca => (
                            <li key={`marca-${marca}`}>
                                <Link to={`/marca/${encodeURIComponent(marca)}`}>{marca}</Link>
                            </li>
                        ))}
                    </ul>
                </div>
                ...
                <div className="footer-section">
                    ...
                    <ul className="footer-links">
                            ...
                            <li><Link to="/metodos-pago">Métodos de Pago</Link></li>
                        <li><Link to="/contacto">Contáctanos</Link></li>
                    </ul>
                </div>

                {/* Sección: Información y Redes Sociales */}
                <div className="footer-section">
                    <h3>Síguenos</h3>
                    ...
                    <div className="footer-contact">
                        ...
                        <p><strong>Dirección:</strong> Estadio Centenario<br />Montevideo, Uruguay</p>
                    </div>
                </div>
            </div>
